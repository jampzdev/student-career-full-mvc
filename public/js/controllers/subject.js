...
.controller('SubjectCtrl', ['createModal', 'helper', '$timeout', '$scope', '$rootScope', '$window', '$state', '$http', 'growlService', 'processExcelFile', 'NgTableParams', 'modalService',
function (createModal, helper, $timeout, $scope, $rootScope, $window, $state, $http, growlService, processExcelFile, NgTableParams, modalService) {
    ...
    $scope.importStudentCsv = function(){
      ...
      $http.post(baseUrl+'/subject/insertFromCsv', form_data,
      {
    ...
    $scope.subjectList = function () {
      $scope.subjectTable  = new NgTableParams({
           sorting : {
           ...
           getData : function($defer, params) {
               ...
               $http({
                   method  : 'POST',
                   url: baseUrl + '/subject/getSubjectList',
                   headers: {
               ...
               .then(function successCallback(response) {
                   ...
                   $scope.subjectTable.total(response.data.totalItems);
